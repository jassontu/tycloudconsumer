...
import ty.cloud.mq.consumer.service.dao.wl.CarStationDao;

@Service("WlCarStationQueueReceiver")
public class WlCarStationQueueReceiver  implements MessageListener {
	...
	private void savedata(String data) {
		CarStationDao csDao = new CarStationDao();
		csDao.insert(data);
	}
