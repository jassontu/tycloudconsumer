...
@Service("WlUserStationQueueReceiver")
public class WlUserStationQueueReceiver implements MessageListener {

	private Logger logger = LoggerFactory.getLogger(WlUserStationQueueReceiver.class);
