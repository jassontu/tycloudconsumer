...
import ty.cloud.mq.consumer.service.dao.wl.StationDao;




@Service("WlStationQueueReceiver")
public class WlStationQueueReceiver  implements MessageListener {
