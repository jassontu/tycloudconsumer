...
import ty.cloud.mq.consumer.service.dao.wl.UserDao;
...
public class WlUserQueueReceiver implements MessageListener {

	private Logger logger = LoggerFactory.getLogger(WlUserQueueReceiver.class);
